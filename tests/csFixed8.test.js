...
test('constructor csFixed8(0.00000001) equals big-endian "0x0000000000000001"', () => {
  expect(new csFixed8(0.00000001).toString(16)).toBe("0x0000000000000001");
});

test('constructor csFixed8(1.0) equals big-endian "0x0000000005f5e100"', () => {
  expect(new csFixed8(1.0).toString(16)).toBe("0x0000000005f5e100");
});
...
test('constructor csFixed8(1.0) equals little-endian "00e1f50500000000"', () => {
  expect(new csFixed8(1.0).toHexString()).toBe("00e1f50500000000");
});

test('constructor csFixed8(-0.00000001) equals little-endian "ff"', () => {
  expect(new csFixed8(-0.00000001).toHexString()).toBe("ff");
});

test('constructor csFixed8(0.00000255) equals little-endian "ff00000000000000"', () => {
